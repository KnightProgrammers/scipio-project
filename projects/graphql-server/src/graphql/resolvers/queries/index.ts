import { BankQueryResolver } from '@/graphql/resolvers/queries/bank-query-resolver';
import { BankAccountQueryResolver } from '@/graphql/resolvers/queries/bank-account-query-resolver';
import { BudgetQueryResolver } from '@/graphql/resolvers/queries/budget-query-resolver';
import { BudgetItemQueryResolver } from '@/graphql/resolvers/queries/budget-item-query-resolver';

...
test.beforeAll(async ({ browser }) => {
	...
	const expensesConf = [
		{
			billableDate: DateTime.fromJSDate(new Date()).plus({day: 1}).toISO(), // Tomorrow
			creditCardId: creditCard1.id
		},
		{
			billableDate: DateTime.fromJSDate(new Date()).toISO(), // Today
			creditCardId: creditCard1.id
		},
		{
			billableDate: DateTime.fromJSDate(new Date()).minus({day: 1}).toISO(), // Yesterday
			creditCardId: creditCard1.id
		},
		{
			billableDate: DateTime.fromJSDate(new Date()).minus({day: 1}).toISO(), // Yesterday
